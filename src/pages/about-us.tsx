    ...
    <>
      ...
      <main>
        ...
        <section className="bg-white text-center py-20 px-10">
          ...
          <p className="mt-8">
            DriverKu adalah layanan yang bergerak dibidang jasa supir dan rental
            mobil aman, nyaman, terpercaya, dan berasuransi. Kami
            memprioritaskan keamanan dan kenyamanan dalam perjalanan Anda. Kami
            juga memiliki supir yang berpengalaman dan profesional, dan tidak
            perlu diragukan lagi dengan berbagai latar belakang dan sertifikat,
            melalui tahap pelatihan yang ketat. Kami juga memiliki mobil yang
            aman dan nyaman serta memiliki asuransi kecelakaan disetiap
            perjalanan Anda.
          </p>
        </section>
